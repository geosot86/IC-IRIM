% SIM_36th is a zero-dimensional model which calculates ice and
...
%(1990) kernel correction and DeMott aerosol-aware primary nucleation
...
function [Q,soln,sol,velg,velG,INPt,enhancement] = SIM_36th(etabr,etaagg,etaRSg,etaRSG,...
...
%      
        ...
        if (T0 > 237 && T0 < 273)
           aa = -14.625; 
            ...
            lapse = -6/1000;
                % moist adiabatic lapse rate of 6 K/km -> [K m-1]
         %  
              naero_cm3=0.6; % prescribe aerosol concentration
 ...
 INPstd =uz*lapse*( -3.33*0.0000594*(273.15-T0)^2.33*(naero_std)^(0.0264*(273.16-T0)+0.0033)-...
  0.0000594*(273.15-T0)^3.33 * 0.0264*log(naero_std)*(naero_std)^(0.0264*(273.16-T0)+0.0033));
      ...
      newNi= 1/(273.15/T0)/(100000/P0)*INPstd*1000;
        else 
            newNi = 0;
        end
    end
